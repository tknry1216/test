...
func TestRandom_types_Uint64(t *testing.T) {
	t.Parallel()

	val1 := random_types_Uint64(nil)
	val2 := random_types_Uint64(nil)

	if val1 == val2 {
		t.Fatalf("random_types_Uint64() returned the same value twice: %v", val1)
	}
}
